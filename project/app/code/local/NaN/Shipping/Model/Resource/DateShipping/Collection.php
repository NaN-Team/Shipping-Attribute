...
class NaN_Shipping_Model_Resource_DateShipping_Collection extends Mage_Core_Model_Resource_Db_Collection_Abstract {

    /**
     * _construct
     */
    public function _construct(){ //Construct di Variant
        $this->_init("nan_shipping/nan_date_shipping");
    }
}